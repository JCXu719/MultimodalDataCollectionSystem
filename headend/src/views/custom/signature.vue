<template>
  <section style="height: auto">
    <h1 class="text-center mt-3 mb-3" style="color: red">实验知情同意书</h1>
    <p>
      您好，我们是合肥工业大学计算机与信息学院媒体计算实验室的研究团队。我们正邀请您参加一项心理学研究。请<span
        class="font-weight-bold"
        style="color: red"
        >仔细阅读本知情同意书并决定是否参与我们的研究</span
      >
    </p>
    <h4>1. 研究目的</h4>
    <p>
    ...
    <p>
      ...
      <span class="font-weight-bold">b. 人口学信息：</span
      >性别、年龄、受教育程度、职业、兴趣爱好等<br />
      <span class="font-weight-bold">c.采集流程：</span
      >采集全程会对您进行录音和录像。采集流程分为如下4步：1）视频刺激：观看一系列视频片段；2）基本问答：回答几个开放式问题；3）墨迹测试：观看墨迹图并陈述感受；4）量表填写：填写一份人格量表。
    </p>
    <h4>3. 本研究的风险</h4>
    <p>
    ...
    <h4>5. 参与本研究获得的奖励</h4>
    <p>
      完成初筛阶段数据采集，在核实视听数据和电子量表的可用性及可靠性之后，您可以获得如下的奖励：只要完成采集流程即可获得1小时的志愿时长，若数据质量高（完全符合要求），可以获得2小时的志愿时长（即获得额外的1小时奖励）<br /><br />
