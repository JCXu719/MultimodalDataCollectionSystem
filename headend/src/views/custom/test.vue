<template>
  <section class="section section-shaped section-lg my-0 text-center">
    <div>
      ...
      <div>
        ...
        <select
          ...
          style="width: 350px; height: 36px; margin-top: 30px"
    ...
    <div style="margin-top: 100px; margin-left: 30px">
      <base-button type="primary" @click="start()">下一步</base-button>
    </div>
  </section>
</template>
