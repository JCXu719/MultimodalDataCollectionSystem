            ...
            >
              ...
              <form role="form" @submit.prevent="registerUser()">
                ...
                <base-input
                  ...
                  alternative
                  :valid="checkrealname"
                  @blur="Setrealnamesafe"
                ></base-input>
                <base-input
                  placeholder="学号（限合肥工业大学学生）"
                ...
                <base-input
                  placeholder="班级（eg.计算机22-1班）"
                  addon-left-icon="fa fa-bandcamp"
                  v-model="classcode"
                  id="class"
                  alternative
                  :valid="checkclass"
                ...
                <base-input
                  type="password"
                  placeholder="密码（8-20字，必须包含大小写字母和数字）"
                ...
                <base-input
                  placeholder="QQ号（5-12位数字）"
                  addon-left-icon="fa fa-handshake-o"
                  v-model="qq"
                  id="qq"
                  alternative
                  :valid="checkqq"
                ...
                <div style="margin-top: 36px">
                  <span>职业</span>
                  <span
                    style="margin-left: 18px; font-weight: bold; font-size: 15px"
                    @click=";(textOpenFlag0 = !textOpenFlag0), showAll0()"
                    >{{ textOpenFlag0 ? '收起' : '展开'
                  ...
                  <div class="listBox0">
                    <div
                      class="list0"
                      v-for="(c, index) of labelList0"
                      :key="index"
                      :class="{ checked: arr0.includes(index) }"
                      @click="checkedBox0(index)"
                    >
                      {{ c }}
                    </div>
                  </div>
                ...
                <div style="margin-top: 26px">
                  ...
                  <span
                    style="margin-left: 18px; font-weight: bold; font-size: 15px"
                    @click=";(textOpenFlag = !textOpenFlag), showAll()"
                    >{{ textOpenFlag ? '收起' : '展开'
                    }}<i class="ni ni-bold-down"></i
                  ></span>
                  <div class="listBox">
